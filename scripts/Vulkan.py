...
ARC_VULKAN_VERSION = '1.2.170.0'
VULKAN_SDK_EXE_PATH = 'Arc/vendor/VulkanSDK/VulkanSDK.exe'
...
def CheckVulkanSDK():
    if (VULKAN_SDK is None):
        ...
        InstallVulkanPrompt()
        return False
    elif (ARC_VULKAN_VERSION not in VULKAN_SDK):
        print(f"Located Vulkan SDK at {VULKAN_SDK}")
        print(f"You don't have the correct Vulkan SDK version! (Arc requires {ARC_VULKAN_VERSION})")
        InstallVulkanPrompt()
        return False
...
OutputDirectory = "Arc/vendor/VulkanSDK"
